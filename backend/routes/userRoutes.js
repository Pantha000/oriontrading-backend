...
const {registerUser, loginUser, logout, forgotPassword, resetPassword, getUserDetails, userVerification, depositUser, sentUpdatePasswordToken, updatePassword, updateProfile, withdrawUser, otsTransfer, fundingToSpot, spotTransfer, aiToSpot} = require("../controllers/userControllers")
